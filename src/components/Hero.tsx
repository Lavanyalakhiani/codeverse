...
export default function Hero() {
  ...
  return (
    <div
      id="home"
      className="relative overflow-hidden before:absolute z-10 before:top-0 before:left-1/2 before:bg-[url('https://images.unsplash.com/photo-1503023345310-bd7c1de61c7d
')] before:bg-no-repeat before:bg-center before:bg-contain before:w-full before:h-full before:-translate-x-1/2 before:-z-10 text-white"
      ...
      <div className="max-w-[85rem] mx-auto px-6 lg:px-8 pt-40 lg:pb-12 md:pb-12 pb-32">
        <div className="text-center">
          ...
          <p className="mt-5 text-lg font-spacegroteskregular text-neutral-400 max-w-2xl mx-auto">
            Welcome to Codeverse, your ultimate collaborative coding platform.
            Code together in real time, share ideas with built-in chat and video
            calls, and unleash the power of AI with Codeverse Genie for smarter
            coding solutions.
          </p>
        </div>
        ...
        <div className="mt-12 hidden lg:grid md:grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 text-center">
          ...
          <div>
            ...
            <p className="mt-2 text-neutral-400 font-spacegroteskregular">
              Get code fixes, suggestions, and generation with Codeverse Genie.
            </p>
          </div>
          <div>
            <h3 className="text-xl font-spacegroteskbold text-blue-400">
