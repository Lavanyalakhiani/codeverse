...
import img1 from "../../public/Lavanya.jpg";
import img2 from "../../public/Komal.jpg";
        ...
        <CardBody className="bg-black flex items-center justify-center flex-col relative group/card border-white/[0.2] w-auto sm:w-[30rem] h-auto rounded-xl p-6 border">
          ...
          <div className="flex justify-center items-center mt-4 gap-4">
            <CardItem
              translateZ={20}
              as={Link}
              href="https://www.linkedin.com/in/lavanya-lakhiani-80552a22b/"
              target="__blank"
            ...
            <CardItem
              ...
              href="https://github.com/Lavanyalakhiani"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
        ...
        <CardBody className="bg-black flex items-center justify-center flex-col relative group/card border-white/[0.2] w-auto sm:w-[30rem] h-auto rounded-xl p-6 border">
          ...
          <div className="flex justify-center items-center mt-4 gap-4">
            <CardItem
              translateZ={20}
              as={Link}
              href="https://www.linkedin.com/in/komal-kumari-sah-645b9b236/"
              target="__blank"
            ...
            <CardItem
              ...
              as={Link}
              className="px-4 py-2 rounded-xl bg-white text-xs font-bold"
              href="https://github.com/komalksah"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
