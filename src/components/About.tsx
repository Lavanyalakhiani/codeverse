            ...
            <div className="w-full flex-col justify-center items-start gap-8 flex">
              <div className="flex-col justify-start lg:items-start items-center gap-4 flex">
                ...
                <div className="w-full flex-col justify-start lg:items-start items-center gap-3 flex">
                  ...
                  <p className="text-gray-300 text-base font-normal leading-relaxed lg:text-start">
                    At Codeverse, our mission is to make coding a shared and 
              ...
              <div className="w-full flex-col justify-center items-start gap-6 flex">
                <p className="text-gray-300 text-base font-normal leading-relaxed">
                  ...
                  Codeverse provides the tools to turn ideas into reality.
                </p>
                <p className="text-gray-300 text-base font-normal leading-relaxed">
                  ...
                  Codeverse is not just about writing code—it's about writing stories 
