...
import Feature2 from "../../public/Screenshot.png";
  ...
  const features = [
    {
      ...
      description:
        "Codeverse offers a real-time collaborative coding playground, enabling seamless teamwork. With support for 5+ programming languages and 20+ color themes, it's designed to cater to diverse developer preferences.",
      image: Feature1,
      color: "bg-black",
    },
    {
