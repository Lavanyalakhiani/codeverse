...
const Navbar = () => {
    ...
    <nav className="bg-opacity-50 backdrop-blur-md fixed w-full z-20 top-0 start-0 rounded-lg shadow-lg">
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        <a href="" className="flex items-center space-x-3 rtl:space-x-reverse">
          <Image src={logo} className="h-10 w-10" alt="Codeverse Logo" />
          ...
          <ul className="bg-black lg:bg-transparent w-full flex flex-col p-4 lg:p-0 mt-4 font-medium border border-white rounded-lg lg:space-x-8 rtl:space-x-reverse lg:flex-row lg:mt-0 lg:border-0">
            <li>
              <button
                ...
                className="block py-2 px-3 text-black hover:text-blue-900 rounded lg:bg-transparent lg:p-0"
                aria-current="page"
              >
                Home
              </button>
            ...
            <li>
              <button
                ...
                className="block py-2 text-black px-3 rounded hover:text-blue-900 lg:hover:bg-transparent lg:p-0"
              >
                Features
              </button>
            </li>
            ...
            <li>
              <button
                ...
                className="block py-2 text-black px-3 rounded hover:text-blue-700 lg:hover:bg-transparent lg:p-0"
              >
                Developers
              </button>
            </li>
  ...
  className="block py-2 px-3 !text-black rounded hover:text-blue-700 lg:hover:bg-transparent lg:p-0"
>
  Contact Us
</button>
